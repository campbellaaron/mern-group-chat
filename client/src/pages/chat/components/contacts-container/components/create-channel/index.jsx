    ...
    <>
        ...
        <Dialog open={newChannelModal} onOpenChange={setNewChannelModal}>
            <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                <DialogHeader>
                <DialogTitle>Please enter channel details</DialogTitle>
                ...
                <div>
                    <Button className="w-full bg-purple-700 hover:bg-purple-900 transition-all duration-300" onClick={createNewChannel}>Create Channel</Button>
                </div>
            </DialogContent>
        </Dialog>
    </>
